...
let vegetableData: [Vegetable] = [
    ...
    Vegetable(title: "胡萝卜", headline: "炖汤美味", image: "carrot", gradientColors: [.blue,.green], description: "原产亚洲西部，阿富汗,10世纪时经伊朗传入欧洲大陆，15世纪英国已有栽培，16世纪传入美国。12世纪经伊朗传入中国，日本在16世纪从中国引入。", classfication: ["伞形科","胡萝卜族","双子叶植物纲"])
]
